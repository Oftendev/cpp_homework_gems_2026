...
# Сборка и Запуск
Собирал и запускал в VScode, используя расширения CMake и CMake tools. Для графики используется библиотека SFML. Она должна сама скачиваться и собираться в папку build при конфигурации и сборке через cmake (указано в файле CMakeLists.txt)